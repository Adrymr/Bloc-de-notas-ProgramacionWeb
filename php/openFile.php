        ...
        <div class="w-100">
            ...
            <div class="container abs-center">
                <div class="" style="width:fit-content;">
                    ...
                    <label for="fileName" class="label mb-2">Nota a visualizar</label><br>
                    ...
                    <input type="submit" name="btn-abrir" value="Abrir"><br>
                    </form>

                    <?php

                    if (isset($_POST["btn-abrir"]) && isset($_POST["fileName"]) && isset($_POST["folderName"])){
                        ...
                        if (is_dir($folder)){
                            if(is_file($file)){
                                $fileTRead = fopen($file, "r") or die ("Error al abrir el archivo"); 
    
                                while(!feof($fileTRead)){
                                $getFile = fgets($fileTRead);
                                $fileContent = nl2br($getFile);
                                echo "<br><h4 class='label mb-2'>Contenido de la nota</h4>";
                                echo "<textarea readonly class='textArea' style='border: 2px solid #4e475e; border-radius: 5px;' cols='80' rows='10'>$fileContent</textarea>";
                            }
                            fclose($fileTRead);
